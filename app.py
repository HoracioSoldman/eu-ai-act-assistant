...
# If using OpenAI for the LLM generation step:
from openai import OpenAI

# Page configuration
st.set_page_config(page_title="EU AI Act RAG Engine", page_layout="centered")
st.title("⚖️ EU AI Act Compliance & Regulation Engine")
